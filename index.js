    ...
    <div class="flex-1 bg-neutral-n0 flex flex-col items-start justify-start pt-6 px-6 pb-35px box-border gap-24px max-w-full lg:pt-5 lg:pb-5 lg:box-border mq750:min-w-full">
        ...
        <div class="self-stretch flex flex-col items-start justify-start gap-12px max-w-full">
            <div class="self-stretch flex flex-col items-start justify-start gap-8px max-w-full">
                ...
                <div class="mt-2 mb-2">
                    <div class=" ">
                        <img class="" loading="lazy" alt="" src="feactured.jpg" />
                    </div>
                </div>
            </div>
            <div class="">
                ...
                <div class="self-stretch flex flex-col items-start justify-start gap-24px max-w-full">
                    <div class="self-stretch flex flex-col items-start justify-start gap-24px max-w-full">
                        <div class="self-stretch flex flex-row items-center justify-between gap-24px max-w-full text-sm mq750:flex-wrap">
                            <div class="h-218px w-280px gap-10px flex flex-col items-center justify-start min-w-380px mq750:flex-1">
                                <img class="  loading="lazy" alt="" src="robot3.jpg" />
                            </div>
                    ...
                    <div class="self-stretch flex flex-col items-start justify-start gap-24px max-w-full">
                        ...
                        <div class="self-stretch flex flex-row items-center justify-between gap-24px max-w-full text-sm mq750:flex-wrap">
                            ...
                            <div class="h-218px w-280px gap-10px flex flex-col items-center justify-start min-w-380px mq750:flex-1">
                                <img class="self-stretch flex-1 relative max-w-full overflow-hidden max-h-full object-cover mq750:self-stretch mq750:w-auto" loading="lazy" alt="" src="New1.jpg" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="ai-marketing-section">
                ...
                <div class="flex justify-center">
                    <img class="h-40% w-40%" src="Automation.jpg" alt="Automation Image" />
                </div>
            </div>
            <div class="items-center justify-center">
                ...
                <div class="flex flex-row items-center">
                    <div class="p-4 ">
                        <img style=width:60%; src="Customer.jpg" alt="Customer Image" />
                    </div>
                    <div class="w-1/2">
            ...
            <div class="container">
                ...
                <div class="image">
                    <img src="work.jpg" alt="Customer Image" />
                </div>
            </div>
            ...
            <div class="self-stretch flex flex-col items-start justify-start gap-8px max-w-full">
                ...
                <div class="self-stretch flex flex-row items-start justify-start gap-24px max-w-full text-accent-a300 mq750:flex-wrap">
                    <img class="h-24 w-24 relative object-cover min-h-96px" loading="lazy" alt="" src="image 17.png">
        ...
        row.addEventListener('click', (event) => {
            // Prevent expanding row when clicking on edit or delete button
            if (event.target.tagName.toLowerCase() === 'button' || event.target.tagName.toLowerCase() === 'i') return;

            // Toggle expandable row display
